...
contract GreenNFTMarketPlace is GreenNFTTradable {
    ...
    constructor(GreenNFTData _greenNFTData, AllGreenCoin _allGreenCoin) public GreenNFTTradable(_allGreenCoin) {
        greenNFTData = _greenNFTData;
        allGreenCoin = _allGreenCoin;

        address payable GREEN_NFT_MARKETPLACE = payable(address(this));
    ...
    function buyCarbonCredits(GreenNFT _greenNFT, uint orderOfCarbonCredits) public payable returns (bool) {
        ...
        allGreenCoin.transfer(buyer, purchaseAmountOfCarbonCredits);
    }
